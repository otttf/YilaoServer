...
class UserSchema(Schema):
    ...
    portrait = fields.Int()
    default_location_longitude = fields.Float(allow_none=True, validate=lambda it: -180 <= it <= 180)
    default_location_latitude = fields.Float(allow_none=True, validate=lambda it: -90 <= it <= 90)
...
class StoreSchema(Schema):
    ...
    location_longitude = fields.Float(allow_none=True, validate=lambda it: -180 <= it <= 180)
    location_latitude = fields.Float(allow_none=True, validate=lambda it: -90 <= it <= 90)
    address = fields.Str(allow_none=True, validate=varchar64)
...
class OrderSchema(Schema):
    id = fields.Int()
    from_user = fields.Int(dump_only=True)
    destination_longitude = fields.Float(allow_none=True, validate=lambda it: -180 <= it <= 180)
    destination_latitude = fields.Float(allow_none=True, validate=lambda it: -90 <= it <= 90)
    address = fields.Str(allow_none=True, validate=varchar64)
